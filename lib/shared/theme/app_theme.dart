...
class AppTheme {
  static const bool _disableGoogleFonts =
      bool.fromEnvironment('DISABLE_GOOGLE_FONTS', defaultValue: false);
  ...
  static ThemeData light() {
    ...
    final bodyTheme = _disableGoogleFonts ? base.textTheme : GoogleFonts.outfitTextTheme(base.textTheme);
    final displayTheme = _disableGoogleFonts ? base.textTheme : GoogleFonts.syneTextTheme(base.textTheme);
    return base.copyWith(
      scaffoldBackgroundColor: Colors.transparent,
      textTheme: bodyTheme.copyWith(
        displayLarge: displayTheme.displayLarge?.copyWith(fontWeight: FontWeight.w700),
        displayMedium: displayTheme.displayMedium?.copyWith(fontWeight: FontWeight.w700),
        displaySmall: displayTheme.displaySmall?.copyWith(fontWeight: FontWeight.w700),
        headlineLarge: displayTheme.headlineLarge?.copyWith(fontWeight: FontWeight.w700),
        headlineMedium: displayTheme.headlineMedium?.copyWith(fontWeight: FontWeight.w700),
        headlineSmall: displayTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w600),
        titleLarge: displayTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600),
        titleMedium: displayTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600),
      ).apply(
